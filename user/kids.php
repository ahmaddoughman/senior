    ...
    <div class="content-man">
        <div class="left-man">
            <div class="mySlides fade">
                <img class="kids-img1" src="assets/images/Kids/cover2.png">
            </div>
            <div class="mySlides fade">
                <img class="kids-img1" src="assets/images/Kids/cover1.png" alt="">
            </div>
            <div class="mySlides fade">
                <img class="kids-img1" src="assets/images/Kids/cover5.png">
            </div>

            <div class="mySlides fade">
                <img class="kids-img1" src="assets/images/Kids/cover4.png">
            </div>
                ...
                <div>
                    ...
                    <script>
                        ...
                        document.getElementById('navigateButton1').onclick = function() {
                            ...
                            window.location.href = 'kids-shoes.php';
                        };
                    </script>
                </div>
                <div>
                    <img id="navigateButton" src="assets/images/Kids/cover3.png" alt="">
                    <script>
                        // JavaScript code
                        document.getElementById('navigateButton').onclick = function() {
                            // Change 'another-page.html' to the URL of the page you want to navigate to
                            window.location.href = 'kids-t-shirts.php';
                        };
                    </script>
                </div>
                <div>
                    <img id="navigateButton3" src="assets/images/image112299.png" alt="">
                    <script>
                        // JavaScript code
                        document.getElementById('navigateButton3').onclick = function() {
                            // Change 'another-page.html' to the URL of the page you want to navigate to
                            window.location.href = 'kids-jeans.php';
                        };
                    </script>
                </div>
                <div>
                    <img id="navigateButton4" src="assets/images/Kids/cover-pajamas.png" alt="">
                    <script>
                        // JavaScript code
                        document.getElementById('navigateButton4').onclick = function() {
                            // Change 'another-page.html' to the URL of the page you want to navigate to
                            window.location.href = 'kids-pajamas.php';
                        };
                    </script>
                </div>
            </div>
                ...
                <div class="category1-collection">
                        ...
                        <div class="product">
                            <div class="collection-image">
                                <div class="img-backgroud">
                                    <img src="assets/images/Kids/pajamas1.png" alt="image">
                                </div>
                                <div class="des">
                                    <p class="product-title descriptionId">cotton pajamas</p>
                    ...
                    <div class="pro1">
                        <div class="product">
                            <div class="collection-image">
                                <div class="img-backgroud">
                                    <img src="assets/images/Kids/pajamas6.png" alt="image">
                                </div>
                                <div class="des">
                                    <p class="product-title descriptionId">pink pajamas</p>
                                    <p class="product-price paragraphId">$22</p>
                                    <div class="btn-change">
                                        <button type="button" onclick="handleButtonClick1(this)" class="button222">more details</button>
                                        <button class="CartBtn add-to-cart">
                                            <span class="IconContainers">
                    ...
                    <div class="pro1">
                        <div class="product">
                            <div class="collection-image">
                                <div class="img-backgroud">
                                    <img src="assets/images/Kids/t-shirt4.png" alt="image">
                                </div>
                                <div class="des">
                                    <p class="product-title descriptionId">frog t-shirt</p>
                                    <p class="product-price paragraphId">$11</p>
                                    <div class="btn-change">
                                        <button type="button" onclick="handleButtonClick1(this)" class="button222">more details</button>
                                        <button class="CartBtn add-to-cart">
                                            <span class="IconContainers">
                    ...
                    <div class="pro1">
                        <div class="product">
                            <div class="collection-image">
                                <div class="img-backgroud">
                                    <img src="assets/images/Kids/t-shirt9.png" alt="image">
                                </div>
                                <div class="des">
                                    <p class="product-title descriptionId">white t-shirts</p>
                                    <p class="product-price paragraphId">$8</p>
                                    <div class="btn-change">
                                        <button type="button" onclick="handleButtonClick1(this)" class="button222">more details</button>
                                        <button class="CartBtn add-to-cart">
                                            <span class="IconContainers">
                    ...
                    <div class="pro1">
                        <div class="product">
                            <div class="collection-image">
                                <div class="img-backgroud">
                                    <img src="assets/images/Kids/shoes4.png" alt="image">
                                </div>
                                <div class="des">
                ...
                <div class="category1-collection">
                    <div class="pro1">
                        <div class="product">
                            <div class="collection-image">
                                <div class="img-backgroud">
                                    <img src="assets/images/Kids/pajamas7.png" alt="image">
                                </div>
                                <div class="des">
                                    <p class="product-title descriptionId">black pajamas</p>
                    ...
                    <div class="pro1">
                        <div class="product">
                            <div class="collection-image">
                                <div class="img-backgroud">
                                    <img src="assets/images/Kids/pajamas8.png" alt="image">
                                </div>
                                <div class="des">
                                    <p class="product-title descriptionId">black pajamas</p>
                    ...
                    <div class="pro1">
                        <div class="product">
                            <div class="collection-image">
                                <div class="img-backgroud">
                                    <img src="assets/images/Kids/shoes3.png" alt="image">
                                </div>
                                <div class="des">
                                    <p class="product-title descriptionId">white shoes</p>
                    ...
                    <div class="pro1">
                        <div class="product">
                            <div class="collection-image">
                                <div class="img-backgroud">
                                    <img src="assets/images/Kids/shoes2.png" alt="image">
                                </div>
                                <div class="des">
                                    <p class="product-title descriptionId">purple shoes</p>
                    ...
                    <div class="pro1">
                        <div class="product">
                            <div class="collection-image">
                                <div class="img-backgroud">
                                    <img src="assets/images/Kids/jeans6.png" alt="image">
                                </div>
                                <div class="des">
                                    <p class="product-title descriptionId">blue jeans</p>
                                    <p class="product-price paragraphId">$10</p>
                                    <div class="btn-change">
                                        <button type="button" onclick="handleButtonClick1(this)" class="button222">more details</button>
                                        <button class="CartBtn add-to-cart">
                    ...
                    <div class="pro1">
                        <div class="product">
                            <div class="collection-image">
                                <div class="img-backgroud">
                                    <img src="assets/images/Kids/jeans7.png" alt="image">
                                </div>
                                <div class="des">
                                    <p class="product-title descriptionId">dark blue jeans</p>
                ...
                <div class="category1-collection">
                    ...
                    <div class="pro1">
                        <div class="product">
                            <div class="collection-image">
                                <div class="img-backgroud">
                                    <img src="assets/images/Kids/jeans3.png" alt="image">
                                </div>
                                <div class="des">
                                    <p class="product-title descriptionId">dark blue jeans</p>
                                    <p class="product-price paragraphId">$19</p>
                    ...
                    <div class="pro1">
                        <div class="product">
                            <div class="collection-image">
                                <div class="img-backgroud">
                                    <img src="assets/images/Kids/shoes8.png" alt="image">
                                </div>
                                <div class="des">
                                    <p class="product-title descriptionId">flower shoes</p>
                                    <p class="product-price paragraphId">$22</p>
                                    <div class="btn-change">
                                        <button type="button" onclick="handleButtonClick1(this)" class="button222">more details</button>
                                        <button class="CartBtn add-to-cart">
                    ...
                    <div class="pro1">
                        <div class="product">
                            <div class="collection-image">
                                <div class="img-backgroud">
                                    <img src="assets/images/Kids/t-shirt7.png" alt="image">
                                </div>
                                <div class="des">
                                    <p class="product-title descriptionId">blue t-shirt</p>
                    ...
                    <div class="pro1">
                        <div class="product">
                            <div class="collection-image">
                                <div class="img-backgroud">
                                    <img src="assets/images/Kids/shoes10.png" alt="image">
                                </div>
                                <div class="des">
                                    <p class="product-title descriptionId">pink shoes</p>
                                    <p class="product-price paragraphId">$16</p>
                                    <div class="btn-change">
                                        <button type="button" onclick="handleButtonClick1(this)" class="button222">more details</button>
                                        <button class="CartBtn add-to-cart">
                                            <span class="IconContainers">
                    ...
                    <div class="pro1">
                        <div class="product">
                            <div class="collection-image">
                                ...
                                <div class="des">
                                    <p class="product-title descriptionId">beauty pajamas</p>
                                    <p class="product-price paragraphId">$28</p>
                                    <div class="btn-change">
                                        <button type="button" onclick="handleButtonClick1(this)" class="button222">more details</button>
                                        <button class="CartBtn add-to-cart">
                                            <span class="IconContainers">
