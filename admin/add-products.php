...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    switch ($category) {
        case "man_tshirts":
            $targetTable = "man_tshirts";
            break;
        case "man_jeans":
            $targetTable = "man_jeans";
            break;
        case "man_shoes":
            $targetTable = "man_shoes";
            break;
        case "man_suits":
            $targetTable = "man_suits";
            break;
        default:
            break;
    }
            ...
            <div>
                <select name="category" class="Categorsss">
                    <optgroup label="Category">
                        <option value="man_tshirts">T-shirts</option>
                        <option value="man_jeans">Jeans</option>
                        <option value="man_shoes">Shoes</option>
                        <option value="man_suits">Suits</option>
                    </optgroup>
                </select>
            </div>
