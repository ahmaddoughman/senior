...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        switch ($category) {
            case "kids_tshirts":
                $targetTable = "kids_tshirts";
                break;
            case "kids_jeans":
                $targetTable = "kids_jeans";
                break;
            case "kids_shoes":
                $targetTable = "kids_shoes";
                break;
            case "kids_pajamas":
                $targetTable = "kids_pajamas";
                break;
            default:
                break;
        }
                ...
                <div>
                    <select name="category" class="Categorsss">
                        <optgroup label="Category">
                            <option value="kids_tshirts">T-shirts</option>
                            <option value="kids_jeans">Jeans</option>
                            <option value="kids_shoes">Shoes</option>
                            <option value="kids_pajamas">pajamas</option>
                        </optgroup>
                    </select>
                </div>
